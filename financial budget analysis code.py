...
data.head() 
print(" \n") 
print("What are the data present in the csv file seperated with category and budget!") 
print(data) 
print(" \n") 
data.dropna() 
print(" \n") 
...
plt.pie(df, labels=labels, autopct='%1.1f%%', startangle=90, pctdistance=0.85, shadow 
=True) 
